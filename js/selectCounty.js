...
function Country() {
	...
	this.init = function() {
		that.countryForm.style.display = "none"; //making form invisible
		//appending text and image when document load
			...
			if (that.parent.getElementsByTagName("ul").length > 0) {
				...
				for (var i = 0; i < that.parent.getElementsByTagName("li").length; i++) {
					that.parent.getElementsByTagName("li")[i].onclick = (function(pos) {
						...
						return function() {
							//appending text and image when dropdown clicked
